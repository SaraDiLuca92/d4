...
for (let i = 0; i < starWarsCharacters.length; i++) {
  //for(let i = 9; i >= 0; i--){
  //console.log(i)
  console.log(i, starWarsCharacters[i].name);
}
characters.push(starWarsCharacters.name);
/* ESERCIZIO 3
  Seguendo i passaggi precedenti crea un array chiamato "femaleCharacters" 
  e inserisci solo oggetti di personaggi femminili con questa struttura di esempio: 
...
femaleCharacters.push(starWarsCharacters.gender);
/* ESERCIZIO 4
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  //for(let i = 9; i >= 0; i--){
  //console.log(i)
  console.log(i, starWarsCharacters[i].eye_color);
}
...
switch (eyeColor) {
  case 0:
    ...
    break;
  case 1:
    starWarsCharacters.eyeColor.yellow;
    console.log(starWarsCharacters.name);
    break;
  case 2:
    starWarsCharacters.eyeColor.brown;
    console.log(starWarsCharacters.name);
    break;
  case 3:
    starWarsCharacters.eyeColor.red;
    console.log(starWarsCharacters.name);
    break;
  case 4:
    starWarsCharacters.eyeColor.bluegray;
    console.log(starWarsCharacters.name);
    break;
  default:
    console.log("unknow");
